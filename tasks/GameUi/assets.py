...
class GameUiAssets: 
	...
	# 斗技 
	I_CHECK_DUEL = RuleImage(roi_front=(146,14,79,48), roi_back=(146,14,79,48), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_duel.png")
	# description 
	...
	# description 
	I_MAIN_GOTO_GUILD = RuleImage(roi_front=(544,611,50,47), roi_back=(520,583,99,105), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_main_goto_guild.png")
	# description 
