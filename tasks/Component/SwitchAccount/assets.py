...
class SwitchAccountAssets: 
	...
	O_SA_SELECT_SVR_SVR_LIST = RuleOcr(roi=(407,122,671,469), area=(407,122,671,469), mode="FULL", method="Default", keyword="", name="sa_select_svr_svr_list")
	# 选择服务器界面 底部角色名 列表 
	O_SA_SELECT_SVR_CHARACTER_LIST = RuleOcr(roi=(407,122,671,469), area=(407,122,671,469), mode="FULL", method="Default", keyword="", name="sa_select_svr_character_list")
	# 选择账号界面 账号列表 
	O_SA_ACCOUNT_ACCOUNT_LIST = RuleOcr(roi=(407,122,671,469), area=(407,122,671,469), mode="FULL", method="Default", keyword="", name="sa_account_account_list")
	# 选择账号界面 已选择的账号 
	...
	# Swipe Rule Assets
	# 登录界面 服务器列表的手指向左滑动 
	S_SA_SVR_SWIPE_LEFT = RuleSwipe(roi_front=(820,505,30,21), roi_back=(818,253,26,21), mode="default", name="sa_svr_swipe_left")
	# 登录界面 账号列表的手指向上滑动 
	...
	# 登录界面-选择手机类型为苹果. 
	I_SA_LOGIN_FORM_APPLE = RuleImage(roi_front=(511,356,96,96), roi_back=(511,356,96,96), threshold=0.8, method="Template matching", file="./tasks/Component/SwitchAccount/res/res_sa_login_form_apple.png")
	# 登录界面-选择手机类型为android 
	I_SA_LOGIN_FORM_ANDROID = RuleImage(roi_front=(672,358,97,92), roi_back=(672,358,97,92), threshold=0.8, method="Template matching", file="./tasks/Component/SwitchAccount/res/res_sa_login_form_android.png")
	# 判断是否在 选择服务器 界面的标志物 角色的服务器图标还未显示时 
	I_SA_CHECK_SELECT_SVR_1 = RuleImage(roi_front=(523,36,229,61), roi_back=(523,36,229,61), threshold=0.8, method="Template matching", file="./tasks/Component/SwitchAccount/res/sa_check_select_svr_1.png")
	# 判断是否在 选择服务器 界面的标志物 角色的服务器图标已经显示时 
	I_SA_CHECK_SELECT_SVR_2 = RuleImage(roi_front=(523,36,229,61), roi_back=(523,36,229,61), threshold=0.8, method="Template matching", file="./tasks/Component/SwitchAccount/res/sa_check_select_svr_1.png")
