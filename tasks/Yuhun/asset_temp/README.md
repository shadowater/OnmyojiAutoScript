...
1. 把截图放进 `<页面>/`  
2. 用 `tools/yuhun_bbox_tool.py` 运行标注（见上级 `readme.md`）  
3. 运行 `python tasks/Yuhun/tools/prepare_yuhun_assets.py --crop-only` 生成模板图与 `select/`、`enhance/`、`result/` 下的 json  
