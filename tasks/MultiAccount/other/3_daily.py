...
daliy_json = "D:\\Software\\yys\\resource\\multi_daily_temp.json"
...
evozone = evozone_task(config,device)
continue_flag =True

task_list = [areaboss, talisman, trifles]
task_list = [evozone]

account_data = pd.read_csv("D:\\Software\\yys\\resource\\task_account\\account_info_asstist.csv")
