...
class RichManAssets: 
	...
	# 白蛋确认 
	I_FS_WHITE_CHECK = RuleImage(roi_front=(591,228,100,100), roi_back=(534,181,201,183), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/friendship_points/friendship_points_fs_white_check.png")
	...
	# 购买检查 
	I_ME_CHECK_BLUE = RuleImage(roi_front=(591,220,100,100), roi_back=(541,179,206,189), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/medal/medal_me_check_blue.png")
	# 购买检查 
	...
	# 契灵商店 
	I_MALL_BONDLINGS_SURE = RuleImage(roi_front=(1194,421,69,74), roi_back=(1194,421,69,74), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_bondlings_sure.png")
	# 已选中契灵商店 
	...
	# 杂货铺 
	I_MALL_SUNDRY_CHECK = RuleImage(roi_front=(1093,10,31,44), roi_back=(1093,10,150,100), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_sundry_check.png")
	...
	# 特殊 
	I_SIDE_CHECK_SPECIAL = RuleImage(roi_front=(153,5,42,42), roi_back=(153,5,42,42), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_check_special.png")
	# 荣誉 
	I_SIDE_SUER_HONOR = RuleImage(roi_front=(1180,191,59,78), roi_back=(1180,191,59,78), threshold=0.6, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_suer_honor.png")
	# 荣誉 
	I_SIDE_CHECK_HONOR = RuleImage(roi_front=(723,8,41,42), roi_back=(723,8,41,42), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_check_honor.png")
	# 友情点 
	I_SIDE_SURE_FRIENDS = RuleImage(roi_front=(1190,287,43,79), roi_back=(1190,287,43,79), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_sure_friends.png")
	# 友情点 
	I_SIDE_CHECK_FRIENDS = RuleImage(roi_front=(908,7,39,43), roi_back=(908,7,39,43), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_check_friends.png")
	# 勋章 
	I_SIDE_SURE_MEDAL = RuleImage(roi_front=(1190,397,39,69), roi_back=(1190,397,39,69), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_sure_medal.png")
	# 勋章 
	I_SIDE_CHECK_MEDAL = RuleImage(roi_front=(535,6,40,44), roi_back=(535,6,40,44), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_check_medal.png")
	# 魅力值 
	I_SIDE_SURE_CHARISMA = RuleImage(roi_front=(1181,499,59,75), roi_back=(1181,499,59,75), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_sure_charisma.png")
	# 魅力值 
	I_SIDE_CHECK_CHARISMA = RuleImage(roi_front=(904,5,48,46), roi_back=(904,5,48,46), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_check_charisma.png")
	...
	# 左数第二个 
	O_MALL_RESOURCE_2 = RuleOcr(roi=(382,8,124,39), area=(382,8,124,39), mode="Quantity", method="Default", keyword="", name="mall_resource_2")
	# 左数第三个 
	O_MALL_RESOURCE_3 = RuleOcr(roi=(574,9,127,38), area=(574,9,127,38), mode="Quantity", method="Default", keyword="", name="mall_resource_3")
	# 左数第四个 
	O_MALL_RESOURCE_4 = RuleOcr(roi=(755,9,128,39), area=(755,9,128,39), mode="Quantity", method="Default", keyword="", name="mall_resource_4")
	# 左数第五个 
	O_MALL_RESOURCE_5 = RuleOcr(roi=(943,9,116,37), area=(943,9,116,37), mode="Quantity", method="Default", keyword="", name="mall_resource_5")
	# 左数第六个 
